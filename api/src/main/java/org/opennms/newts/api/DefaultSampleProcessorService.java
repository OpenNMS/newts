 ...
 * @author eevans
 */
public class DefaultSampleProcessorService implements SampleProcessorService  {

    private static final Logger LOG = LoggerFactory.getLogger(DefaultSampleProcessorService.class);
    ...
    @Inject
    public DefaultSampleProcessorService(@Named("sampleProcessor.maxThreads") int maxThreads, Set<SampleProcessor> processors) {
     ...
     * {@link DefaultSampleProcessorService#submit(Collection)} are non-blocking unless the pool is unable
